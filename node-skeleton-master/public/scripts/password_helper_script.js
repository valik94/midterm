...
$(document).ready(function () {
  ...
  const fillAlert = function (notification) {
    ...
    $("#alert_placeholder").html(
      '<div class="alert alert-primary" role="alert" style="position:abolute;z-index:999;">' +
        notification +
        "</div>"
    );
  };
  ...
  const fillAlertError = function (notification) {
    console.log("ran!");
    $("#alert_placeholder").html(
      '<div class="alert alert-danger" role="alert" style="position:abolute;z-index:999;">' +
        notification +
        "</div>"
    );
  };
  ...
  const createPassword = function () {
    ...
    $("#pwordSubmission").on("click", function () {
      const errors = {
        ...
        checkBoxesEmpty:
          "Sorry. You can't generate a password with all boxes unchecked. Try again!",
      };
      ...
      $.ajax({
        ...
        const notification =
          "Typed password created! Go to the homepage to view it!";
    ...
    $("#pwordSubmission2").on("click", function () {
      const errors = {
        urlempty: "Sorry. You can't leave the URL field empty. Try again!",
        passwordEmpty:
          "Sorry. You can't create a password that is empty. Try again!",
      };
